function d = headTracker(action,vid_dir,use_centroid)
...
% Specifies whether to use the centroid of the head or posterior mean
if nargin < 3
    use_centroid = 0;
end
...
% If run without action defined, run 'start'
if nargin < 1
    action = 'start';
end
