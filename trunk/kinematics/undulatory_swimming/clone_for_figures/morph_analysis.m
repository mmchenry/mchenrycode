...
dts = [dts(:,2)./dts(:,3) dts(:,4)./dts(:,3)];

kvals = [.91 .43; .71 .33; .66 .29; .82 .40; .83 .42; .80 .43; .77 .42];

kvals = [kvals (kvals(:,1)+kvals(:,2))./(1+kvals(:,1))];
...
im_dir = '/Volumes/Docs/Manuscripts/Krijn_Ulrike_paper/Figures/linked tiffs';
